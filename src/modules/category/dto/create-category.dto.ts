...
export class CreateCategoryDto {
  ...
  @Length(1, 64, { message: '栏目名称最大为64个字符' })
  catname: string;

  @ApiPropertyOptional({ description: '栏目名称英文' })
  @Length(1, 64, { message: '栏目名称英文最大为64个字符' })
  @IsOptional()
  catnameEn: string;

  @ApiProperty({ description: '栏目目录' })
  @IsNotEmpty({ message: '栏目目录不能为空' })
  @Length(1, 64, { message: '栏目目录最大为64个字符' })
  catdir: string;

  @ApiPropertyOptional({ description: '栏目描述' })
  @Length(0, 255, { message: '栏目描述最大为255个字符' })
  @IsOptional()
  description: string;
  ...
  @IsOptional()
  @Length(0, 255, { message: 'SEO描述最大为255个字符' })
